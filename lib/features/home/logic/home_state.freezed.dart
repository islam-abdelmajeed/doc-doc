...
mixin _$HomeState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(List<Doctor?>? doctorData) doctorsSuccess,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(List<Doctor?>? doctorData)? doctorsSuccess,
...
abstract class _$$DoctorsSuccessImplCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<Doctor?>? doctorData});
}
...
class _$DoctorsSuccessImpl implements DoctorsSuccess {
  const _$DoctorsSuccessImpl(final List<Doctor?>? doctorData)
      : _doctorData = doctorData;

  final List<Doctor?>? _doctorData;
  @override
  List<Doctor?>? get doctorData {
    final value = _doctorData;
    if (value == null) return null;
    if (_doctorData is EqualUnmodifiableListView) return _doctorData;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableListView(value);
  }
  ...
  @override
  String toString() {
    return 'HomeState.doctorsSuccess(doctorData: $doctorData)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other._doctorData, _doctorData));
  }

  @override
  int get hashCode => Object.hash(
      runtimeType, const DeepCollectionEquality().hash(_doctorData));
  ...
  TResult when<TResult extends Object?>({
    ...
    return doctorsSuccess(doctorData);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return doctorsSuccess?.call(doctorData);
  }
...
abstract class DoctorsSuccess implements HomeState {
  const factory DoctorsSuccess(final List<Doctor?>? doctorData) =
